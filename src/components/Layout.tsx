...
const APP_TITLE = 'Software-Testanwendung';
...
const navigation = [
  ...
  { name: 'Testfall-Erfassung', href: '/testfall-erfassung', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Testfall-Erfassung', href: '/gateway/apps/69c50bd3d38d8ccb727de8f4?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c50bd3d38d8ccb727de8f4?template=list_page"
